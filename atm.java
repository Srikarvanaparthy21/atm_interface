...
public class atm {
    ...
    public static void createAccount() {
        ...
        if (!h.containsKey(t1)) {
            t2 = passwordchecker();
            System.out.println("Minimum balance must be greater than or equals to :" + minimum_balance
                    + " so please enter intial deposit");
            while (true) {
                b = sc.nextInt();
    ...
    public static void main(String[] args) {
        user a = new user(12500, "eshwar", "1234");
        user b = new user(11200, "bhanu", "1235");
        user c = new user(15200, "nikesh", "1256");
        user d = new user(11350, "rahul", "1230");
        user e = new user(12400, "abhinav", "1455");
        h.put("eshwar", a);
        h.put("bhanu", b);
        h.put("nikesh", c);
        h.put("rahul", d);
